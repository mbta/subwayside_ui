defmodule SubwaysideUiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SubwaysideUiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SubwaysideUiWeb.Gettext, "errors", msg, opts)
    end
  end
